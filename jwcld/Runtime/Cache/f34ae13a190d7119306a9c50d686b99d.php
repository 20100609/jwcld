...
<div id='wrapper'>
    ...
    <div class='controls'>
        ...
        <div class='form-wrapper'>
            ...
            <form id="form" accept-charset="UTF-8" action="<?php echo U('Login/verify');?>" method="post">
                <div class='row-fluid'>
                    <div class='span12 icon-over-input'>
                        <input class="span12" id="username" name="username" placeholder="用户名[工作证号]" type="text" value="" />
                ...
                <button class="btn btn-block" name="button" type="submit" id="submit">登录</button>
            </form>
        </div>
        <div class='row-fluid'>
        ...
        <div class='alert alert-info' align="center" id="info" style="display: none;">
            <a href="#" class="close" data-dismiss="alert">&times;</a>
            <h3 style="color:#9E0000;">
                <i class='icon-info-sign'></i>
                请输入用户名[职工号]和用户密码，用户信息同北师大统一身份认证系统信息一致。
            </h3>
        </div>
    </div>
